...
/*   Updated: 2024/02/01 15:01:28 by hfafouri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->enemy_frames[0] = mlx_xpm_file_to_image(mlx, "./bonus/enemy/enem.xpm",
			&data->width, &data->height);
	exit_invalid_xpm(data->enemy_frames[0]);
	data->enemy_frames[1] = mlx_xpm_file_to_image(mlx,
			"./bonus/enemy/enem2.xpm", &data->width, &data->height);
	exit_invalid_xpm(data->enemy_frames[1]);
	data->enemy_frames[2] = mlx_xpm_file_to_image(mlx,
			"./bonus/enemy/enem3.xpm", &data->width, &data->height);
	exit_invalid_xpm(data->enemy_frames[2]);
	data->enemy_frames[3] = mlx_xpm_file_to_image(mlx,
			"./bonus/enemy/enem4.xpm", &data->width, &data->height);
	exit_invalid_xpm(data->enemy_frames[3]);
	data->enemy_frames[4] = mlx_xpm_file_to_image(mlx,
			"./bonus/enemy/enem5.xpm", &data->width, &data->height);
	exit_invalid_xpm(data->enemy_frames[4]);
	data->enemy_frames[5] = mlx_xpm_file_to_image(mlx,
			"./bonus/enemy/enem6.xpm", &data->width, &data->height);
	exit_invalid_xpm(data->enemy_frames[5]);
	data->enemy_frames[6] = mlx_xpm_file_to_image(mlx,
			"./bonus/enemy/enem7.xpm", &data->width, &data->height);
	exit_invalid_xpm(data->enemy_frames[6]);
	data->enemy_frames[7] = mlx_xpm_file_to_image(mlx,
			"./bonus/enemy/enem8.xpm", &data->width, &data->height);
	exit_invalid_xpm(data->enemy_frames[7]);
}
...
void	load_image(void *mlx, t_data *data)
{
	...
	data->mvmnt = mlx_xpm_file_to_image(mlx, "./utils/mov.xpm", &data->width,
			&data->height);
	exit_invalid_xpm(data->mvmnt);
}
